                    ...
                    <div class="box-body">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Select AC No</label>
                                <select name="accountno" id="accountno" class="form-control" style="width: 100%;">
								<option>ALL</option>
                        ...
                        <div class="col-md-3">
                         ...
                         <div class="col-md-3">
                            <div class="form-group">
                                <label></label>
                                <input type="submit" name="btnsearch" onclick="BankStatementAjax();" value="View Statement" id="btnsearch" class="btn btn-success margin-20" />
                            </div>
                        </div>
                    </div>
