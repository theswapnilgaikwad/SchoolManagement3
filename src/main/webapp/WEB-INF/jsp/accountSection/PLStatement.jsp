	...
	<option value="Main Office - 002">Main Office - 002</option>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <input name="fromdate" type="date"  readonly="readonly" id="fromdate" class="form-control" data-inputmask="&#39;alias&#39;: &#39;dd/mm/yyyy&#39;" data-mask="" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <input name="todate" type="date" readonly="readonly" id="todate" class="form-control" data-inputmask="&#39;alias&#39;: &#39;dd/mm/yyyy&#39;" data-mask="" />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="box-footer">
                            <div class="row col-md-12">
                                <input type="submit" name="btnsearch" value="Search" id="btnsearch" class="btn btn-success pull-right" />
                            </div>
                        </div>
                    </div>
	...
	<option value="Main Office - 002">Main Office - 002</option>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="selectfyear"  id="selectfyear" class="form-control" style="width: 100%;">
	<option selected="selected" value="FY-2022-2023">FY-2022-2023</option>
