                              ...
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-8">
                                    <select name="searchbyPolicyNo"
                                       id="searchbyPolicyNo"
                                       onchange="javascript:getByAddInvesmentCode(); RetriveDataIns();"
...
<!--                                  <input type="submit" name="btnview" -->
<!--                                     value="View Installment" onclick="RetriveDataIns();"  id="btnview" -->
...
<!--                                      /> -->
   ...
   <table cellspacing="0" cellpadding="3" rules="all" 
                              ...
                              border="1"  style="width:100%;border-collapse:collapse;">
                                 <caption>
                                  <center><b>INSTALLMENTS</b></center>  
...
<!--                                     <th scope="col">Date</th> -->
      ...
      <!-- Select2 -->
      <script src="dist/js/MonthlyRenewaljs.js"></script>
