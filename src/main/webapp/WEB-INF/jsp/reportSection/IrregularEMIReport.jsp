            ...
            <div class="col-xs-12">
                <div class="box box-info">
                    ...
                    <div class="box-body">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label></label>
                                <button id="btnSearch" class="btn btn-success margin-20" onclick="IrregularEMIReportAjax();"><span class="fa fa-search"></span> SEARCH</button>
                            </div>
                ...
                <div class="box box-success" style="box-shadow: none; overflow: auto !important;">
                    <div class="box-header with-border">
                        ...
                        <div>  
                          <h5 style="text-align: center; font-weight: bold; ">EMI COLLECTION REPORT</h5>
	                        <hr>
