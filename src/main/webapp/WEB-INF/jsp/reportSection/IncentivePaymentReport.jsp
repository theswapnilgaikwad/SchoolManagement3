...
//]]>
      ...
      <section class="content-header">
        <h1 id="ContentPlaceHolder1_IdHeader">Incentive Payment Report</h1>
        <ol class="breadcrumb">
            ...
            <div class="col-xs-12">
                         ...
                         <div class="col-md-2">
                            <div class="form-group">
                                <label></label>
                            	 ...
                            	 <button type="submit"  onclick="IncentivePaymentReport();" class="btn btn-success pull-right margin-20" >Search</button>
                            </div>
                ...
                <div class="box box-success" style="box-shadow: none; overflow: auto !important;">
                    <div class="box-header with-border">
                        ...
                        <div>
                        	<h4 style="text-align: center;"><b>INCENTIVE PAYMENT REPORT</b></h4>
                        	<hr>
