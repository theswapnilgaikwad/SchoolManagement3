...
//]]>
                    ...
                    <div class="box-body">
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <select name="businessType" id="businessType" class="form-control" style="width: 100%;">
	...
	<option value="ONLY RENEW">ONLY RENEW</option>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label></label>
                                <button type="submit"  onclick="getBusinessType(); " class="btn btn-success pull-right margin-20" >Search</button>
                            </div>
