...
//]]>
    ...
    <section class="content-header">
        <h1 id="ContentPlaceHolder1_IdHeader">Projection Report</h1>
        <ol class="breadcrumb">
	...
	<option value="003">Main Office - 003</option>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <select name="planeName" id="planeName" class="form-control" style="width: 100%;">
	<option value="">Select</option>
	...
	<option value="RD">RD</option>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label></label>
                               <button type="submit"  onclick="getProjectionREport();" class="btn btn-success pull-right margin-20" >Search</button>
                            </div>
