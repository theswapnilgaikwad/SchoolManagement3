...
<body onload="getAllGroupMaster()" class="skin-blue sidebar-mini" style="height: auto; min-height: 100%; background-color: rgba(36, 105, 92, 0.15);" cz-shortcut-listen="true">
    <form method="post" action="saveDataRegularEMIRepayment" onsubmit="javascript:return WebForm_OnSubmit();" id="form1">
                        ...
                        <div class="box-body">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-sm-4 control-label">Incentive Month <strong style="color: Red">*</strong></label>
                                    <div class="col-sm-8">
                                        <input name="month" type="text" id="month" class="form-control" PlaceHolder="Enter Incentive Month" />
                                        <span id="monthMsg" style="color:Red;font-size:X-Small;font-weight:bold;display:none;">Enter Incentive Month</span>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-4 control-label">From Date <strong style="color: Red">*</strong></label>
                                    <div class="col-sm-8">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-4 control-label">To Date <strong style="color: Red">*</strong></label>
                                    <div class="col-sm-8">
                                        <div class="input-group date">
                                            <div class="input-group-addon">
                                                <i class="fa fa-calendar"></i>
                            ...
                            <div class="col-md-6">
                                <div class="box box-success" style="box-shadow: none; height:250px; overflow: auto !important;">
