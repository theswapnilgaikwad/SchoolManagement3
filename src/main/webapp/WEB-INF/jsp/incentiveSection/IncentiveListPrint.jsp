...
<body class="skin-blue sidebar-mini" style="height: auto; min-height: 100%; background-color: rgba(36, 105, 92, 0.15);" cz-shortcut-listen="true">
    <form method="post" action="http://admin:eqfi%23123@eqfinidhi.eadmin.in/Admin/IncentiveListPrint.aspx" id="form1">
...
//]]>
                    ...
                    <div class="box-body">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select name="ctl00$ContentPlaceHolder1$ddlVmonth" id="ContentPlaceHolder1_ddlVmonth" class="form-control" style="width: 100%;">
	...
	<option value="001">Main Office - 001</option>
                       ...
                       <div class="col-md-3">
                            <div class="form-group">
                                <label>Code :</label>
                               <input name="ctl00$ContentPlaceHolder1$txtCode" type="text" id="ContentPlaceHolder1_txtCode" class="form-control" />
                            </div>
