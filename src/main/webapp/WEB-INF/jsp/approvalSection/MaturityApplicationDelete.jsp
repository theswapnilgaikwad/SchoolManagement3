...
<body class="skin-blue sidebar-mini" style="height: auto; min-height: 100%; background-color: rgba(36, 105, 92, 0.15);" cz-shortcut-listen="true">
    <form method="post" action="http://admin:eqfi%23123@eqfinidhi.eadmin.in/Admin/MaturityApplicationDelete.aspx" id="form1">
...
//]]>
    ...
    <section class="content-header">
        <h1 id="ContentPlaceHolder1_IdHeader">Maturity Application Delete</h1>
        <ol class="breadcrumb">
	...
	<option value="001">Main Office - 001</option>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label></label>
                                <a id="ContentPlaceHolder1_btnSearch" class="btn btn-success margin-20" 
