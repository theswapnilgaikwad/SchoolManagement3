...
<body onload="getAllDestignation()" class="skin-blue sidebar-mini" style="height: auto; min-height: 100%; background-color: rgba(36, 105, 92, 0.15);" cz-shortcut-listen="true">
   <form method="post" action="saveDesignationMasterData" name="saveDesignametionMaster" 
                     ...
                     <div class="box box-success">
                           ...
                           <div class="col-md-12">
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-8">
                                    ...
                                    <span id="designationNameMsg" style="color:Red;font-size:X-Small;font-weight:bold;display:none;">Enter Designation Name</span>
                                 </div>
                              </div>
                           </div>
                        </div>
                        <div class="box-footer">
                           <div class="row col-md-12">
                              ...
                              <button type="button" name="save" value="Save" onclick="return validateGoldLoanMaster()" 
